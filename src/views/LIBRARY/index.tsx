  ...
  const libraryListMock:LibraryContent[] = [
    {
      ...
      desc: {
        ...
        // 무엇을 위해
        for: [
            '1. 개인의 경력 관리 필요성과 더불어 인사 채용 담당자 등 공중 관계의 효율적인 플랫폼이 필요',
            '2. 경력 기간 동안 백엔드와 단위 기술에만 집중되어, 전체 소프트웨어의 흐름에 대한 지식과 이해를 증진',
            '3. 동시에 클라이언트와 개발자의 입장이 되어 시각 차이를 이해',
        ],
        // 기타 내용
        detail: [
          '1. 인사 채용 담당자의 바쁜 일정을 고려하여 반응형으로 페이지를 제공합니다.',
          '2. 개인 소개, 포트폴리오, 토이 프로젝트 링크, 커뮤니케이션(게시판 등)을 한 페이지에서 접할 수 있습니다.',
          '3. 메인 페이지를 3차원 섹션으로 요약하여 전체 페이지 구성을 한눈에 볼 수 있습니다.',
          '4. Notion API를 연동하여, 노션에서 변경하는 포트폴리오 내용을 즉각 가시화할 수 있습니다.',
          '5. 게스트 게시판을 통해 닉네임과 비밀번호만 입력하여 관리자와 소통할 수 있습니다.',
        ]
      },
      skills: [
